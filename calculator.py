...
#=============================display================================================
operator=''
txt_input = StringVar(value = "calculating...")
...
btndot = Button(root,padx=35,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = '.',bg='orange',command = lambda :btn('*')).grid(row=4 , column=1)
btndivision = Button(root,padx=36,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = '/',bg='orange',command = lambda :btn('/')).grid(row=4 , column=2)
btnmultiply = Button(root,padx=34,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = '*',bg='orange',command = lambda :btn('*')).grid(row=4 , column=3)

#=======================row5===========================================================
btnequal = Button(root,padx=95,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = '=',bg='green',command =equal).grid(row=5 , column=0, columnspan = 2)
btnopenbracket = Button(root,padx=35,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = '(',bg='orange',command = lambda :btn('(')).grid(row=5 , column=2)
btnclosebracket = Button(root,padx=38,pady=15,bd=8,fg='black',font=('arial',30,'bold'), text = ')',bg='orange',command = lambda :btn(')')).grid(row=5 , column=3)
